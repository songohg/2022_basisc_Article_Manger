...
public class ArticleController extends Controller {
	...
	public void makeTestData() {
		...
		Container.articleService.add(new Article(Container.articleService.setArticleId(), Util.getNowDateStr(), 1, "제목1", "내용1", 11));
		Container.articleService.add(new Article(Container.articleService.setArticleId(), Util.getNowDateStr(), 2, "제목2", "내용2", 22));
		Container.articleService.add(new Article(Container.articleService.setArticleId(), Util.getNowDateStr(), 2, "제목3", "내용3", 33));
	}
}
